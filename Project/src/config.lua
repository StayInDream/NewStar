...
GAME_SOUND = {
    Bgm_01        = "sound/poptile/Bgm_01.mp3",
    Eff_Crash     = "sound/poptile/Eff_Crash.mp3",
    Eff_GameOver  = "sound/poptile/Eff_GameOver.mp3",
    Eff_GetItem   = "sound/poptile/Eff_GetItem.mp3",
	Eff_Warning   = "sound/poptile/Eff_Warning.mp3",
